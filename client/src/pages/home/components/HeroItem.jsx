...
const HeroItem = ({ genderType }) => {
    return (
        <Link to={`/products/${genderType?.title}`} className='w-1/2 h-full group relative cursor-pointer'>
            ...
            <div className='absolute p-12 flex flex-col gap-4 bottom-0 group-hover:scale-110 transition duration-300'>
