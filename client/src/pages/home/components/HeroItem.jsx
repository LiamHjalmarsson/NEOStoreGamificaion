...
const HeroItem = ({ item }) => {
    return (
        <Link to={`/products/${item.title}`} className='w-full md:w-1/2 h-1/2 md:h-full group relative cursor-pointer'>
            ...
            <div className='absolute w-full h-full flex flex-col justify-end gap-4 top-0 p-12 lg:p-24 transition duration-500 text-stone-200 bg-stone-800 bg-opacity-40 group-hover:bg-opacity-30 dark:bg-opacity-60 dark:group-hover:bg-opacity-45'>
