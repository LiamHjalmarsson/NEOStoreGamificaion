...
const Stat = ({ stat }) => {
    return (
        <div className='bg-stone-200 dark:bg-stone-800 rounded-xl shadow lg:min-w-48 p-4 grow text-center lg:h-48 flex items-center flex-col transition duration-500 relative'>
