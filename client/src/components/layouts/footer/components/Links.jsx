...
const Links = () => {
    ...
    return (
        <div className="sm:flex sm:items-center sm:justify-between">
            <ul className="flex justify-between max-lg:flex-col gap-4 w-1/2 mx-auto items-center mb-6 text-sm uppercase font-medium text-stone-800 sm:mb-0 dark:text-stone-200">
                {links.map(link => (
                    <li key={link}>
