...
const Input = ({ input, custom, error }) => {
    return (
        <div className={`${custom ? custom : ""} grow flex relative flex-col`}>
            <label
                htmlFor={input.id}
                className='absolute -top-3 left-4 bg-stone-200 dark:bg-stone-800 px-2 duration-500 transition-colors'
            >
