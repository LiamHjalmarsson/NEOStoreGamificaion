...
const CategoryCard = ({ category }) => {
    return (
        <Link to={"/categories/" + category.title} className='flex-grow min-w-64 relative group bg-stone-800 flex justify-center items-center overflow-hidden'>
            <img src={category.image} className='object-cover object-center w-full h-72 opacity-70 group-hover:opacity-50 duration-500 transition group-hover:scale-110' alt={"no alt"} />
